...
> ⚠️ **重要**: 詳細な導入方法、最新のコマンド仕様、トラブルシューティングについては、必ず **[公式Wiki](https://mcproxvc.ovh/wiki/)** を参照してください。

## ✨ 主な特徴
* **Webベースで完結**: 複雑なアプリのインストールは不要。ブラウザだけで利用できます。
* **立体音響 (Spatial Audio)**: 音の方向や距離感がリアルに反映されます。
* **スマホ対応**: iPhone/Androidでも動作し、専用アプリも用意されています。
* **多機能**: スペクテイター設定や、iPhoneでの音量調整に対応。
